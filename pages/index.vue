      ...
      >
        ...
        >
          <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">
            <!-- Phone marketing headline -->
            Enjoy freedom with the new iPhone 12 Pro
          </h2>
          <p class="mt-6 text-lg leading-8 text-gray-300">
            <!-- Phone marketing description -->
            The new iPhone 12 is here. Choose from a range of colors and
            storage options. Buy now with free delivery.
          </p>
          <div
          ...
          >
            ...
            >
            <NuxtLink href="listing" class="text-sm font-semibold leading-6 text-white"
              >See options <span aria-hidden="true">→</span></NuxtLink
            >
          </div>
        </div>
