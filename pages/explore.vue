        ...
        <div class="lg:pr-4">
          <div class="lg:max-w-lg">
            ...
            <p class="mt-6 text-xl leading-8 text-gray-700">
              The iPhone 12 Pro is here. Featuring a 6.1” Super Retina XDR
              display, Ceramic Shield with 4x better drop performance, and LiDAR
              Scanner for night mode portraits.
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
            ...
            <ul role="list" class="mt-8 space-y-8 text-gray-600">
              <li class="flex gap-x-3">
                ...
                <span
                  ><strong class="font-semibold text-gray-900">Facetime</strong>
